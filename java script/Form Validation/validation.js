...
function angka(e) {
	...
	if (!/^[0-9]+$/.test(e.value)) {
		window.alert("Tolong Masukkan jumlah tiket dengan benar");
...
function validasi() {
	...
	if (nama && email && pukul && tujuan && tiket) {
		document.getElementById("chatbox").innerHTML = "Nama : " + nama + "<br>" + "Email : " + email + "<br>" + "pukul Berangkat : " + pukul + "<br>" + "Tujuan : " + tujuan + "<br>" + "Jumlah Tiket : " + tiket + "<br><br>" + "Selamat Traveling";
		return false;
	} else {
